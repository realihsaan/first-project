...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            ...
            <div class="ms-auto">
                <div class="btn-group">
                    <button type="button" class="btn"><a href="{{route('goindex')}}" class="btn btn-light">View Routes</a></button>
                                ...
                                <div class="row g-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            ...
                                            <input type="text" class="form-control" placeholder="Driver Name"> <!-- <input type="password" class="form-control" id="InputPassword" value="12345678"> -->
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-4">
