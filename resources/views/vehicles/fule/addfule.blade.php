...
<div class="page-wrapper">
    <div class="page-content">
        ...
        <div class="page-breadcrumb d-none d-sm-flex align-items-center mb-3">
            <div class="breadcrumb-title pe-3">Add Fule</div>
            <div class="ps-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0 p-0">
                        <li class="breadcrumb-item"><a href="javascript:;"><i class="bx bx-home-alt"></i></a>
                        </li>
                        <li class="breadcrumb-item active" aria-current="page">Add Fule</li>
                    </ol>
                </nav>
            </div>
            <div class="ms-auto">
                <div class="btn-group">
                    <button type="button" class="btn"><a href="{{route('fuleHistory')}}" class="btn btn-light">View History</a></button>
                            ...
                            <div id="test-l-2" role="tabpanel" class="bs-stepper-pane" aria-labelledby="stepper1trigger2">
                                ...
                                <div class="row g-3">
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <label for="InputEmail2" class="form-label"> Fuel is coming from </label>
                                              <!-- <input type="text" class="form-control" placeholder=" Display Name    ">  -->
                                            <select class="form-select" id="InputCountry" aria-label="Default select example">
                                                <!-- <option selected></option> -->
                                                <option value="1">Fule Tank</option>
                                    ...
                                    <div class="row g-3">
                                        <div class="col-12 col-lg-3">
                                            <label for="InputCountry" class="form-label">Start Meter</label>
                                              <input type="text" class="form-control" placeholder="Start Meter">
											  <small>Meter reading at time of fuel-up</small>
						
                                            
                                        </div>
                                        <div class="col-12 col-lg-3">
                                            <label for="InputCountry" class="form-label">Reference</label>
                                        ...
                                        <div class="col-12 col-lg-3">
                                            <label for="InputCountry" class="form-label"> Fule Qty</label>
											<input type="text" class="form-control" placeholder="Fule Qty ">
									...
									<div class="row g-3">
                                        <div class="col-12 col-lg-4">
                                            <label for="InputUsername" class="form-label">  State/Province  </label>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <label for="InputEmail2" class="form-label"> Note </label>
                                        ...
                                        <div class="col-12 col-lg-4">
                                            <label for="InputPassword" class="form-label"> Select Image</label>
